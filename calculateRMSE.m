...
global S_model
global S_exp
S_model=forward_homogeneous(Model, Medium, Geometry,absorption_coefficient*1000);
[S_model_processed, S_exp_processed] =processsignals(S_model,S_exp, Model, Medium,Geometry,a*100);
